...
public class MockServiceTest {
    ...
    public void listSizeTest(){
        ...
        list.add(new Champion("다리우스","탑",1));
        list.add(new Champion("티모","미드",1));
    ...
    public void returnMockAndOnceCalledThenCheckSkin(){
        when(mockService.findByName(anyString())).thenReturn(new Champion("다리우스","탑",1));
    ...
    @Test
    public void 여러개면검색호출검층(){
        List<Champion> champions = new ArrayList<>();
        champions.add(new Champion("티모","탑",1));
        champions.add(new Champion("피오라","탑",1));
